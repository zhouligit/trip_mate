...
class User(Base):
    ...
    realname_verified: Mapped[int] = mapped_column(SmallInteger(), default=0, nullable=False)
...
class UserProfile(Base):
    ...
    personality_test_done: Mapped[int] = mapped_column(SmallInteger(), default=0, nullable=False)
...
class Group(Base):
    ...
    threshold_count: Mapped[int] = mapped_column(Integer(), default=30, nullable=False)
...
class Friendship(Base):
    ...
    friend_user_id: Mapped[int] = mapped_column(BigInteger(), ForeignKey("users.id"), nullable=False)
    created_at: Mapped[datetime] = mapped_column(DateTime, server_default=func.current_timestamp(), nullable=False)
...
class Vote(Base):
    ...
    is_valid: Mapped[int] = mapped_column(SmallInteger(), default=0, nullable=False)
    winner_option_id: Mapped[int | None] = mapped_column(BigInteger(), nullable=True)
...
class VoteOption(Base):
    ...
    id: Mapped[int] = mapped_column(BigInteger(), primary_key=True, autoincrement=True)
    vote_id: Mapped[int] = mapped_column(BigInteger(), ForeignKey("votes.id"), nullable=False)
...
class VoteRecord(Base):
    ...
    id: Mapped[int] = mapped_column(BigInteger(), primary_key=True, autoincrement=True)
    vote_id: Mapped[int] = mapped_column(BigInteger(), ForeignKey("votes.id"), nullable=False)
    option_id: Mapped[int] = mapped_column(BigInteger(), ForeignKey("vote_options.id"), nullable=False)
    user_id: Mapped[int] = mapped_column(BigInteger(), ForeignKey("users.id"), nullable=False)
    created_at: Mapped[datetime] = mapped_column(DateTime, server_default=func.current_timestamp(), nullable=False)
...
class Ticket(Base):
    ...
    user_id: Mapped[int] = mapped_column(BigInteger(), ForeignKey("users.id"), nullable=False)
    group_id: Mapped[int] = mapped_column(BigInteger(), ForeignKey("groups.id"), nullable=False)
    qr_code: Mapped[str] = mapped_column(String(128), nullable=False)
...
class Rating(Base):
    ...
    __table_args__ = (UniqueConstraint("group_id", "user_id", name="uk_group_user_rating"),)

    id: Mapped[int] = mapped_column(BigInteger(), primary_key=True, autoincrement=True)
    group_id: Mapped[int] = mapped_column(BigInteger(), ForeignKey("groups.id"), nullable=False)
    user_id: Mapped[int] = mapped_column(BigInteger(), ForeignKey("users.id"), nullable=False)
    mate_score: Mapped[int] = mapped_column(SmallInteger(), nullable=False)
    route_score: Mapped[int] = mapped_column(SmallInteger(), nullable=False)
    bus_score: Mapped[int] = mapped_column(SmallInteger(), nullable=False)
