...
### `POST /api/v1/tm/auth/wechat/login`
...
```http
POST /api/v1/tm/auth/wechat/login HTTP/1.1
Host: www.wang-hao-hao.cn
...
```http
POST /api/v1/tm/auth/logout HTTP/1.1
Host: www.wang-hao-hao.cn
Authorization: Bearer <token>
```
...
### `POST /api/v1/tm/dna/submissions`
...
### `POST /api/v1/tm/users/personality-test`

说明：与 `POST /api/v1/tm/dna/submissions` 类似，响应为：
...
### `GET /api/v1/tm/match/recommendations`
...
### `GET /api/v1/tm/discovery/groups`
...
### `GET /api/v1/tm/groups/my?type=created|joined`
...
### `POST /api/v1/tm/groups/{group_id}/join`
...
### `POST /api/v1/tm/groups/{group_id}/vote/start`
...
### `POST /api/v1/tm/groups/{group_id}/votes/sessions`
...
### `GET /api/v1/tm/groups/{group_id}/votes/sessions/current`
...
### `POST /api/v1/tm/groups/{group_id}/votes`
...
### `GET /api/v1/tm/groups/{group_id}/votes/result`
...
### `POST /api/v1/tm/votes/{vote_id}/cast`
...
### `GET /api/v1/tm/votes/{vote_id}/result`
...
### `GET /api/v1/tm/verification/me/status`
...
### `POST /api/v1/tm/verification/wechat`
...
### `POST /api/v1/tm/verification/idcard`
...
### `POST /api/v1/tm/orders/pay`

返回结构同 `POST /api/v1/tm/orders/{order_id}/pay/wechat`。

---

## 8.3 获取微信支付参数（mock）

### `POST /api/v1/tm/orders/{order_id}/pay/wechat`
...
### `POST /api/v1/tm/orders/{order_id}/refund/apply`
...
### `POST /api/v1/tm/payments/wechat/notify`
...
### `POST /api/v1/tm/tickets/generate`
...
### `GET /api/v1/tm/groups/{group_id}/ratings/summary`
...
### `POST /api/v1/tm/admin/groups/{group_id}/assign-bus`
